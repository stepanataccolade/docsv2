...
## Configuring BYON
To set up your BYON for your subscription, go to documentation on [Subscription settings](/navigatingUI/subscriptionsSettings/#Nodes) which explains how to configure your subscription to use your own build infrastructure to learn more.
